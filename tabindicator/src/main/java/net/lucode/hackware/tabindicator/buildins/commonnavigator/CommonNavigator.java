package net.lucode.hackware.tabindicator.buildins.commonnavigator;
...
import net.lucode.hackware.tabindicator.NavigatorHelper;
import net.lucode.hackware.tabindicator.R;
import net.lucode.hackware.tabindicator.ScrollState;
...
import net.lucode.hackware.tabindicator.buildins.commonnavigator.abs.IMeasurablePagerTitleView;
...
import net.lucode.hackware.tabindicator.buildins.commonnavigator.model.PositionData;
